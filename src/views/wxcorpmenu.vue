    ...
    <div class="tool">
      <div class="btn">
        <Poptip
          ...
          :title="'确认要删除菜单吗？'"
          @on-ok="del"
          v-if="limits.indexOf('wxcorpmenudel') !== -1"
        >
        ...
        <Button
          type="primary"
          icon="md-add"
          v-if="limits.indexOf('wxcorpmenuadd') !== -1"
          @click="addShow"
        >
          添加
        </Button>
        <Button
          type="info"
          icon="md-create"
          v-if="limits.indexOf('wxcorpmenuedit') !== -1"
          @click="editShow"
        >
          编辑
        </Button>
        <Button
          type="success"
          icon="md-arrow-up"
          v-if="limits.indexOf('wxcorpmenuup') !== -1"
          @click="up"
        >
          上传
        </Button>
      ...
      <div class="search">
        <Select v-model="agentid" @on-change="load" style="width: 200px;">
          <Option
    ...
    load() {
      this.$http
        ...
        .then(data => {
          ...
          if (this.agentid === 0) this.agentid = data.agents[0].agentid;
        });
    },
    addShow() {
      this.menuid = 0;
